...
void InitDebugProc(void)
{
	...
	//デバッグ表示用フォントの生成
	D3DXCreateFont(pDevice, 18, 0, 0, 0, FALSE, SHIFTJIS_CHARSET, OUT_DEFAULT_PRECIS, DEFAULT_QUALITY, DEFAULT_PITCH, "Terminal", &g_pFont2);
...
void DrawDebugProc(void)
{
	...
	{//デバックモードがオンの時
	 //テキストの描画
		g_pFont2->DrawText(NULL, &g_aStrDebug[0], -1, &rect, DT_LEFT, D3DCOLOR_RGBA(0, 0, 0, 255));
	}
